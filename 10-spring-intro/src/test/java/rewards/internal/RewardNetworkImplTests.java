...
public class RewardNetworkImplTests {
	...
	public void testRewardForDining() {
		...
		Dining dining = Dining.createDining("1500.00", "1234123412341234", "1234567890");
		...
		assertEquals(MonetaryAmount.valueOf("300.00"), contribution.getAmount());

		// the total contribution amount should have been split into 2 distributions
		assertEquals(2, contribution.getDistributions().size());

		// each distribution should be 4.00 (as both have a 50% allocation)
		assertEquals(MonetaryAmount.valueOf("120.00"), contribution.getDistribution("Annabelle").getAmount());
		assertEquals(MonetaryAmount.valueOf("180.00"), contribution.getDistribution("Corgan").getAmount());
	}
}