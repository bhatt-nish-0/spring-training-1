...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Account byCreditCard = this.accountRepository.findByCreditCard(dining.getCreditCardNumber());

		System.out.println("account is");
		System.out.println(byCreditCard.getName());
		System.out.println(byCreditCard.getNumber());
		System.out.println(byCreditCard.getBeneficiaries());

		Restaurant byMerchantNumber = this.restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		System.out.println("restaurant information");
		System.out.println(byMerchantNumber.getBenefitPercentage());
		System.out.println(byMerchantNumber.getNumber());
		System.out.println(byMerchantNumber.getName());
		System.out.println(byMerchantNumber.getEntityId());


		MonetaryAmount monetaryAmount = byMerchantNumber.calculateBenefitFor(byCreditCard, dining);
		System.out.println("monetary amount is");
		System.out.println(monetaryAmount.asBigDecimal());

		AccountContribution accountContribution = byCreditCard.makeContribution(monetaryAmount);
        this.accountRepository.updateBeneficiaries(byCreditCard);
		RewardConfirmation rewardConfirmation = this.rewardRepository.confirmReward(accountContribution, dining);
